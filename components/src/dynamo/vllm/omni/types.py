...
class StageRequest(BaseModel):
    ...
    stage_connector_refs: dict[str, Any] | None = None
    sampling_params_list: dict | None = None
    # Global final stage selected by the router for this request. Single-stage
    # workers pass this through vLLM-Omni request metadata so upstream stages
    # emit the multimodal sidecars required by downstream stages.
    final_stage_id: int | None = None
